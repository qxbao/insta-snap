  ...
  dashboard: {
    main: {
      ...
      migration: {
        ...
        description: "Phát hiện dữ liệu snapshot cũ trong browser.storage. Chuyển sang IndexedDB...",
      ...
      cronjob: {
        ...
        desc: "Tự động chụp snapshot theo chu kỳ định sẵn",
        interval: "Chu kỳ",
        interval_w_unit: "Chu kỳ (đơn vị: giờ)",
        interval_placeholder: "Nhập chu kỳ (đơn vị: giờ)",
        last_run: "Lần chạy cuối",
        add_schedule: "Thêm tác vụ",
        no_cron_recommend: 'Chưa có tác vụ tự động nào. Nhấn "Thêm tác vụ" để tạo mới.',
        interval_required: "Chu kỳ là bắt buộc",
        interval_min_er: "Chu kỳ phải ít nhất 1 giờ",
        interval_max_er: "Chu kỳ không được vượt quá 168 giờ (1 tuần)",
