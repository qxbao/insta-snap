  ...
  <div v-if="checking || needsMig || migrationComplete" class="card mb-6">
    <div class="flex items-start gap-4">
      <div
        ...
        :class="
          migrationComplete ? 'bg-green-100 dark:bg-green-900' : 'bg-blue-100 dark:bg-blue-900'
        "
      >
        <Fa6SolidSpinner
        ...
        />
        <Fa6SolidCheck v-else-if="migrationComplete" class="text-green-600 dark:text-green-400" />
